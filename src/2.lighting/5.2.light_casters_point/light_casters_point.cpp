...
bool doInitBeforeGLRenderLoop() {
    gdShader = new GDShader("5.2.shader.vs", "5.2.shader.fs");
...
void onRender() {
    ...
    gdShader->setFloat("light.constant", 1.0f);
    gdShader->setFloat("light.linear", 0.09f);
    gdShader->setFloat("light.quadratic", 0.032f);

    glm::vec3 lightPosition(0.6f, 0.6f, 2.0f);
