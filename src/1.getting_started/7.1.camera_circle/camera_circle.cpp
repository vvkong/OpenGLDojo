...
bool doInitBeforeGLRenderLoop() {
    gdShader = new GDShader("7.1.shader.vs", "7.1.shader.fs");
...
static const GLfloat radios = 5.0f;
void onRender() {
    ...
    GLfloat cameraX = radios * cos(glfwGetTime());
    GLfloat cameraZ = radios * sin(glfwGetTime());
