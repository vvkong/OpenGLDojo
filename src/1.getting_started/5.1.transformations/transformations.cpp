...
bool doInitBeforeGLRenderLoop() {
    gdShader = new GDShader("5.1.shader.vs", "5.1.shader.fs");
...
void onRender() {
    ...
    // glm::mat4 translateTrans = glm::translate(oneMat, glm::vec3(1.0f, 1.0f, 0.0f));
    // glm::mat4 scaleTrans = glm::scale(oneMat, glm::vec3(0.5f, 0.5f, 0.0f));
    // glm::mat4 trans = scaleTrans * translateTrans;
    glm::mat4 trans = glm::mat4(1);
    trans = glm::scale(trans, glm::vec3(0.5f, 0.5f, 0.0f));
    trans = glm::translate(trans, glm::vec3(1.0f, 1.0f, 0.0f));
    angle += 0.01;
    trans = glm::rotate(trans, angle, glm::vec3(0.0f, 0.0f, 1.0f));
    GLint transformLocation = glGetUniformLocation(gdShader->getShaderProgram(), "transform");
